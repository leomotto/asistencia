...
import { db, auth, getPath, initAuth as fbInitAuth, loginWithGoogle, loginAnonymously, logout } from "./firebase-config.js?v=9.18";
import { showToast } from "./ui.js?v=9.18";
import { PERIODOS_CALENDARIO } from "./constants.js?v=9.18";
