...
import { db, auth, getPath, initAuth as fbInitAuth, loginWithGoogle, loginAnonymously, logout } from "./firebase-config.js?v=10.59";
import { showToast } from "./ui.js?v=10.59";
import { PERIODOS_CALENDARIO } from "./constants.js?v=10.59";
