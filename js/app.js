...
import { showToast, mostrarSkeletonTable, mostrarSkeletonCards, showConfirm, switchTab, toggleDarkMode, popularCursos, popularPeriodos, initTheme, toggleMenuMobile, toggleSidebar, initSidebar, cargarVersion, renderAgenda, buildContextSwitcher, switchContext, enterContextAndGoTo } from "./ui.js?v=10.93";
import { setupAuthListener, iniciarSesionGoogle, cerrarSesion, entrarModoDesarrollo, showDevButton, initAuth, setAppTenant, actualizarBadgePendientes } from "./auth.js?v=10.93";
import { cargarOnboardingEscuelas, onboardingEscuelaCambiada, solicitarUnirseEscuela } from "./onboarding.js?v=10.93";
import { HORARIOS_DINAMICOS, cargarMateriasDinamicas, cargarListaMateriasAdmin, abrirModalMateria, cerrarModalMateria, agregarDiaMateria, guardarMateria, eliminarMateria, abrirModalGenerador, cerrarModalGenerador, ejecutarGenerador } from "./materias.js?v=10.93";
import { 
...
window.app.reactivarAlumno           = reactivarAlumno;
...
window.app.registrarCambioPPI              = registrarCambioPPI;
window.app.aplicarPPIMasivo                = aplicarPPIMasivo;
window.app.tomarNotaOficial                = tomarNotaOficial;
window.app.tomarTodosOficiales              = tomarTodosOficiales;
window.app.limpiarImportacionErronea        = limpiarImportacionErronea;
...
// miescuela.js
window.app.abrirModalMiescuela             = abrirModalMiescuela;
window.app.traerYCompararMiescuela         = traerYCompararMiescuela;
window.app.sincronizarMiescuela            = sincronizarMiescuela;
window.app.importarNotasMiescuela          = importarNotasMiescuela;
window.app.usarUltimaPlanillaMiescuela     = usarUltimaPlanillaMiescuela;
