...
import { db, getPath } from "./firebase-config.js?v=9.13";
import { showToast } from "./ui.js?v=9.13";
import { PERIODOS_CALENDARIO } from "./constants.js?v=9.13";
import { HORARIOS_DINAMICOS } from "./materias.js?v=9.13";
import { normalizeDateToISO, formatISOToDisplay, escaparHTML } from "./utils.js?v=9.13";
import { calcularNotaFinalYCondicion } from "./evaluaciones.js?v=9.13";
