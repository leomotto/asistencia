...
import { db, getPath } from "./firebase-config.js?v=9.14";
import { showToast } from "./ui.js?v=9.14";
import { PERIODOS_CALENDARIO } from "./constants.js?v=9.14";
import { HORARIOS_DINAMICOS } from "./materias.js?v=9.14";
import { normalizeDateToISO, formatISOToDisplay, escaparHTML } from "./utils.js?v=9.14";
import { calcularNotaFinalYCondicion } from "./evaluaciones.js?v=9.14";
