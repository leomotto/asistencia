...
import { PERIODOS_CALENDARIO } from "./constants.js?v=9.7";
import { HORARIOS_DINAMICOS } from "./materias.js?v=9.7";
import { normalizeDateToISO, formatISOToDisplay, escaparHTML } from "./utils.js?v=9.7";
